        ...
        <nav class="navbar navbar-expand-lg navbar-dark" aria-label="Ninth navbar example">
            <div class="container-xl">
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->routeIs('buyer.cart.index') ? 'active' : '' }}"
                           href="{{ route('buyer.cart.index') }}">Ver Carrito</a>
                    </li>
                </ul>
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse"
                        data-bs-target="#mainNavbarCollapsable" aria-controls="mainNavbarCollapsable"
                        aria-expanded="false"
                            ...
                            @auth
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->segment(2) == 'dashboard' ? 'active' : '' }}"
                                       href="{{ \App\Domain\Users\Services\EntryPoint::resolveRedirectRoute() }}">Dashboard</a>
                                </li>
